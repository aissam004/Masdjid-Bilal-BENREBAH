...
public class AlertMaker {
    ...
    public static void showMaterialDialog(StackPane root, Node nodeToBeBlurred, List<JFXButton> controls, String header, String body) {
        ...
        if (controls.isEmpty()) {
            controls.add(new JFXButton("حسنا"));
        }
    ...
    public static void showTrayMessage(String title, String message) {
        try {
            ...
            BufferedImage image = ImageIO.read(AlertMaker.class.getResource(MasdjidUtil.ICON_IMAGE_LOC));
            TrayIcon trayIcon = new TrayIcon(image, "Masdjid");
            trayIcon.setImageAutoSize(true);
            trayIcon.setToolTip("Masdjid");
            tray.add(trayIcon);
